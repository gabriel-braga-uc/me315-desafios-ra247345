---
title: "desafio4-247345"
format: html
editor: visual
---

```{r}
# Professor o arquivo flights.csv.zip é muito grande para por no github!
# O senhor precisa baixa-lo e tê-lo na pasta "dados" os labs que o usam funcionarem
...
arquivo_voos <- "../dados/flights.csv.zip"
arquivo_aeroportos <- "../dados/airports.csv"
```
